...
public class Game {
	...
	private static final Font BIG = new Font("Sans Serif", Font.BOLD, 25);
	...
	private static final double[] COLOR_KEY_CENTER = { 35, 500 };
	...
	private void makeMove(AI ai) {
		...
		if (board.isEmpty()) {
			...
			//String bestWord = new String(characters);
			ArrayList<ArrayList<Square>> allWords = new ArrayList<ArrayList<Square>>();
			allWords.add(word);
			ai.addScore(findScore(allWords, true));
			//ai.addScore(ai.findScore(bestWord));
		} else {
